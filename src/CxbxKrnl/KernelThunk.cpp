...
xbaddr CxbxKrnl_KernelThunkTable[379] =
{
	...
	PANIC(0x006A),                             // 0x006A (106) TODO : FUNC(KeInitializeDeviceQueue)
	...
	PANIC(0x0072),                             // 0x0072 (114) TODO : FUNC(KeInsertByKeyDeviceQueue)
	PANIC(0x0073),                             // 0x0073 (115) TODO : FUNC(KeInsertDeviceQueue)
	PANIC(0x0074),                             // 0x0074 (116) TODO : FUNC(KeInsertHeadQueue)
	PANIC(0x0075),                             // 0x0075 (117) TODO : FUNC(KeInsertQueue)
	PANIC(0x0076),                             // 0x0076 (118) TODO : FUNC(KeInsertQueueApc)
	...
	PANIC(0x007B),                             // 0x007B (123) TODO : FUNC(KePulseEvent)
	PANIC(0x007C),                             // 0x007C (124) TODO : FUNC(KeQueryBasePriorityThread)
	...
	PANIC(0x0083),                             // 0x0083 (131) TODO : FUNC(KeReleaseMutant)
	PANIC(0x0084),                             // 0x0084 (132) TODO : FUNC(KeReleaseSemaphore)
	PANIC(0x0085),                             // 0x0085 (133) TODO : FUNC(KeRemoveByKeyDeviceQueue)
	PANIC(0x0086),                             // 0x0086 (134) TODO : FUNC(KeRemoveDeviceQueue)
	PANIC(0x0087),                             // 0x0087 (135) TODO : FUNC(KeRemoveEntryDeviceQueue)
	PANIC(0x0088),                             // 0x0088 (136) TODO : FUNC(KeRemoveQueue)
	...
	PANIC(0x008D),                             // 0x008D (141) TODO : FUNC(KeRundownQueue)
	FUNC(KeSaveFloatingPointState),            // 0x008E (142)
	FUNC(KeSetBasePriorityThread),             // 0x008F (143)
	PANIC(0x0090),                             // 0x0090 (144) TODO : FUNC(KeSetDisableBoostThread)
	FUNC(KeSetEvent),                          // 0x0091 (145)
	PANIC(0x0092),                             // 0x0092 (146) TODO : FUNC(KeSetEventBoostPriority)
	PANIC(0x0093),                             // 0x0093 (147) TODO : FUNC(KeSetPriorityProcess)
	...
	PANIC(0x00BF),                             // 0x00BF (191) TODO : FUNC(NtCreateIoCompletion)
