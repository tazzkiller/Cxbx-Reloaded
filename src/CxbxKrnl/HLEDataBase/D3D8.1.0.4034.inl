...
OOVPATable D3D8_4034[] = {
	...
	REGISTER_OOVPAS(D3DDevice_Clear, 4034), // PATCH 
	...
	// ******************************************************************
	REGISTER_OOVPAS(D3DDevice_GetTransform, 4039), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SelectVertexShader, 4039), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BlockUntilVerticalBlank, 4039), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderTarget, 4039), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPixelShader, 4039), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Begin, 4039), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetShaderConstantMode, 4039), // PATCH 
	// ******************************************************************
	...
	REGISTER_OOVPAS(D3DDevice_GetViewport, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetViewport, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTransform, 4034), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_BeginVisibilityTest, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_EndVisibilityTest, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CopyRects, 4034), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_SetTextureState_ColorKeyColor, 4034), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_SetIndices, 4034), // DISABLED
	REGISTER_OOVPAS(D3DDevice_SetRenderState_EdgeAntiAlias, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_FillMode, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_BackFillMode, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_FogColor, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_FrontFace, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_LogicOp, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleAntiAlias, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleMask, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_NormalizeNormals, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_ShadowFunc, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_Simple, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_StencilEnable, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_StencilFail, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_YuvEnable, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_TwoSidedLighting, 4034), // PATCH 
	...
	REGISTER_OOVPAS(Get2DSurfaceDesc, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_ZEnable, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_LightEnable, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetLightEnable, 3911), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_TextureFactor, 4034), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_SetLight, 4034), // PATCH 
	REGISTER_OOVPAS(D3DVertexBuffer_Lock, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTexture, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPalette, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTextureState_TexCoordIndex, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetMaterial, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexShader, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Swap, 4034), // PATCH 
	REGISTER_OOVPAS(D3D_KickOffAndWaitForIdle, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreateImageSurface, 4034), // DISABLED
	REGISTER_OOVPAS(D3DDevice_GetBackBuffer, 4034), // PATCH 
};
