...
OOVPATable D3D8_4361[] = {
	...
	REGISTER_OOVPAS(D3D_CMiniport_GetDisplayCapabilities, 4361), // DISABLED

	REGISTER_OOVPAS(Direct3D_CreateDevice, 3911), // PATCH Was 4361
	REGISTER_OOVPAS(MakeRequestedSpace, 4361), // PATCH 
	REGISTER_OOVPAS(D3D_CheckDeviceFormat, 4134), // DISABLED
	REGISTER_OOVPAS(D3DDevice_LoadVertexShader, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SelectVertexShader, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderTarget, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_AddRef, 4361), // PATCH 
	REGISTER_OOVPAS(D3D_ClearStateBlockFlags, 4361), // XREF
	REGISTER_OOVPAS(D3DDevice_SetGammaRamp, 3925), // PATCH 
	REGISTER_OOVPAS(D3D_RecordStateBlock, 4361), // XREF
	REGISTER_OOVPAS(D3DDevice_BeginStateBlock, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CaptureStateBlock, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DeleteStateBlock, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_ApplyStateBlock, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_EndStateBlock, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CopyRects, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreateImageSurface, 4034), // DISABLED
	REGISTER_OOVPAS(D3DDevice_GetBackBuffer, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetRenderTarget, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetDepthStencilSurface, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreateVertexShader, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexShaderConstant, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreatePixelShader, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPixelShader, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPixelShaderProgram, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetViewport, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetViewport, 4361), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_GetTexture2, 3911), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTexture, 4361), // PATCH Was 4034
	REGISTER_OOVPAS(D3DDevice_SwitchTexture, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetDisplayMode, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Clear, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Swap, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreateVertexBuffer, 3925), // DISABLED
	REGISTER_OOVPAS(D3DDevice_EnableOverlay, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_UpdateOverlay, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BlockUntilVerticalBlank, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTextureState_TexCoordIndex, 4361), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_SetRenderState_ZEnable, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_StencilEnable, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleAntiAlias, 4134), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_DrawVerticesUP, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DrawIndexedVertices, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetLight, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetLight, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetMaterial, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_LightEnable, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetLightEnable, 4361), // PATCH 
	REGISTER_OOVPAS(D3DVertexBuffer_Lock, 4034), // PATCH 
	REGISTER_OOVPAS(D3DResource_Register, 3925), // PATCH 
	REGISTER_OOVPAS(D3DResource_Release, 4361), // PATCH 
	REGISTER_OOVPAS(D3DResource_IsBusy, 4361), // PATCH 
	REGISTER_OOVPAS(Get2DSurfaceDesc, 4134), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_CreateIndexBuffer, 3925), // DISABLED TODO: This needs to be verified on 4361, not just 4242!
	...
	REGISTER_OOVPAS(D3DDevice_SetPalette, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Reset, 4134), // PATCH 
	REGISTER_OOVPAS(D3D_KickOffAndWaitForIdle, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_TwoSidedLighting, 4134), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_SetRenderState_LogicOp, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_StencilFail, 4134), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_SetRenderState_Dxt1NoiseEnable, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleMask, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleMode, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleRenderTargetMode, 4134), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_DrawIndexedVerticesUP, 4134), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_SetRenderState_LineWidth, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetSwapCallback, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetTile, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTile, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_IsBusy, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetGammaRamp, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetCreationParameters, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BeginVisibilityTest, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_EndVisibilityTest, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetVisibilityTestResult, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetShaderConstantMode, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetFlickerFilter, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetSoftDisplayFilter, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_PrimeVertexCache, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BeginPush, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_EndPush, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Begin, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_End, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVerticalBlankCallback, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexData2f, 4134), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_BlockOnFence, 4134), // PATCH 
	REGISTER_OOVPAS(D3D_GetAdapterIdentifier, 3925), // DISABLED
	REGISTER_OOVPAS(D3DDevice_Release, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BeginPushBuffer, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_EndPushBuffer, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_RunPushBuffer, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetPushBufferOffset, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreateCubeTexture, 4361), // DISABLED
	REGISTER_OOVPAS(D3DCubeTexture_GetCubeMapSurface, 4361), // PATCH 
	REGISTER_OOVPAS(Lock2DSurface, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetScissors, 4361), // PATCH 
	REGISTER_OOVPAS(D3D_SetPushBufferSize, 3925), // DISABLED
	REGISTER_OOVPAS(D3DDevice_SetRenderState_PSTextureModes, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPixelShaderProgram, 4361), // PATCH 
