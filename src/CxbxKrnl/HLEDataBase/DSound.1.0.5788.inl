...
OOVPATable DSound_5788[] = {
	...
	REGISTER_OOVPAS(CDirectSound_SetRolloffFactor, 5788), // XREF
	...
	REGISTER_OOVPAS(IDirectSound_SetEffectData, 5788), // PATCH 
	...
	REGISTER_OOVPAS(CDirectSoundStream_SetPitch, 5788), // PATCH 
	...
	REGISTER_OOVPAS(CDirectSound_SetAllParameters, 5788), // XREF
	REGISTER_OOVPAS(IDirectSound_SetAllParameters, 3936), // PATCH 
	REGISTER_OOVPAS(CMcpxVoiceClient_SetFilter, 5788), // XREF
	...
	REGISTER_OOVPAS(CDirectSoundVoice_SetMode, 5788), // XREF
	REGISTER_OOVPAS(CDirectSoundBuffer_SetMode, 5788), // XREF
	REGISTER_OOVPAS(IDirectSoundBuffer_SetMode, 5788), // PATCH 
