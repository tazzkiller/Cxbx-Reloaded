...
OOVPATable DSound_5233[] = {
	...
	REGISTER_OOVPAS(CDirectSound_SynchPlayback, 5233), // PATCH Was XREF
	...
	REGISTER_OOVPAS(CDirectSound_EnableHeadphones, 5233), // XREF
	REGISTER_OOVPAS(IDirectSound8_EnableHeadphones, 5233), // PATCH 
	...
	REGISTER_OOVPAS(CDirectSoundVoice_SetMode, 5233), // XREF
