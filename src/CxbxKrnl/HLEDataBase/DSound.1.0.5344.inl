...
OOVPATable DSound_5344[] = {
	...
	REGISTER_OOVPAS(CMcpxAPU_SynchPlayback, 5233), // XREF
	REGISTER_OOVPAS(CDirectSound_SynchPlayback, 5344), // PATCH Was XREF
	REGISTER_OOVPAS(IDirectSound_SynchPlayback, 5233), // PATCH 
	...
	REGISTER_OOVPAS(CDirectSound_SetVelocity, 5344), // XREF
	REGISTER_OOVPAS(IDirectSound_SetVelocity, 3936), // PATCH 
	REGISTER_OOVPAS(CDirectSoundVoiceSettings_SetMixBins, 5344), // XREF
	...
	REGISTER_OOVPAS(CDirectSoundStream_SetMixBins, 5233), // PATCH 
	REGISTER_OOVPAS(CDirectSound_SetPositionA, 5344), // XREF
	...
	REGISTER_OOVPAS(CDirectSoundStream_SetFrequency, 5233), // PATCH 
	...
	REGISTER_OOVPAS(CDirectSound_EnableHeadphones, 5344), // XREF
	...
	REGISTER_OOVPAS(CDirectSoundVoice_SetDistanceFactor, 5344), // XREF
	...
	REGISTER_OOVPAS(CDirectSound_SetDistanceFactor, 5344), // XREF
	REGISTER_OOVPAS(IDirectSound_SetDistanceFactor, 4134), // PATCH 
	REGISTER_OOVPAS(CDirectSoundVoice_SetDopplerFactor, 5344), // XREF
	...
	REGISTER_OOVPAS(CDirectSound_SetDopplerFactor, 5344), // XREF
	REGISTER_OOVPAS(IDirectSound_SetDopplerFactor, 3936), // PATCH 
	REGISTER_OOVPAS(CDirectSound_CommitDeferredSettings, 5344), // PATCH 
	...
	REGISTER_OOVPAS(CDirectSoundVoice_SetFormat, 5233), // XREF
	REGISTER_OOVPAS(CDirectSoundBuffer_SetFormat, 4627), // XREF
	REGISTER_OOVPAS(IDirectSoundBuffer_SetFormat, 4627), // PATCH 
	REGISTER_OOVPAS(CDirectSoundVoice_SetMode, 5344), // XREF
	REGISTER_OOVPAS(CDirectSoundBuffer_SetMode, 5233), // XREF
	REGISTER_OOVPAS(IDirectSoundBuffer_SetMode, 5233), // PATCH 
	REGISTER_OOVPAS(CDirectSoundVoice_SetRolloffCurve, 5344), // XREF
	...
	REGISTER_OOVPAS(CDirectSound_SetI3DL2Listener, 5344), // XREF
	...
	REGISTER_OOVPAS(CDirectSound_SetRolloffFactor, 5344), // XREF
	REGISTER_OOVPAS(IDirectSound_SetRolloffFactor, 5344), // PATCH Was 4134
	...
	REGISTER_OOVPAS(CDirectSoundBuffer_SetHeadroom, 5344), // XREF
	REGISTER_OOVPAS(IDirectSoundBuffer_SetHeadroom, 5344), // PATCH 
	...
	REGISTER_OOVPAS(CMcpxVoiceClient_SetFilter, 5344), // XREF
	...
	REGISTER_OOVPAS(CDirectSoundBuffer_StopEx, 5344), // XREF
	...
	REGISTER_OOVPAS(CDirectSoundVoice_SetAllParameters, 5344), // XREF
	...
	REGISTER_OOVPAS(CDirectSoundVoice_SetConeOutsideVolume, 5344), // XREF
	...
	REGISTER_OOVPAS(WaveFormat_CreateXboxAdpcmFormat, 5344), // XREF
	REGISTER_OOVPAS(XAudioCreateAdpcmFormat, 5344), // PATCH 
	REGISTER_OOVPAS(IDirectSound_CreateSoundStream, 3936), // PATCH 
	REGISTER_OOVPAS(CDirectSoundVoice_SetConeAngles, 5344), // XREF
	...
	REGISTER_OOVPAS(CDirectSoundVoice_SetConeOrientation, 5344), // XREF
