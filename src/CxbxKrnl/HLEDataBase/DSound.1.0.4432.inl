...
OOVPATable DSound_4432[] = {
	...
	REGISTER_OOVPAS(DirectSoundGetSampleTime, 4432), // PATCH 
	...
	REGISTER_OOVPAS(IDirectSound_Release, 4432), // PATCH 
	...
	REGISTER_OOVPAS(CDirectSoundVoiceSettings_SetMixBins, 4432), // XREF
