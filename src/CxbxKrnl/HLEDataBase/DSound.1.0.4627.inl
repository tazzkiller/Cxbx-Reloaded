...
OOVPATable DSound_4627[] = {
	...
	REGISTER_OOVPAS(CDirectSoundVoice_SetFormat, 4627), // XREF
	...
	REGISTER_OOVPAS(CDirectSoundStream_SetMixBinVolumes2, 4627), // PATCH 
	...
	REGISTER_OOVPAS(CMcpxBuffer_GetStatus, 4721), // XREF
	REGISTER_OOVPAS(CDirectSoundBuffer_GetStatus, 4721), // XREF
	...
	REGISTER_OOVPAS(XFileCreateMediaObjectEx, 4627), // PATCH 
	REGISTER_OOVPAS(XWaveFileCreateMediaObject, 4627), // PATCH 
	REGISTER_OOVPAS(CDirectSoundBuffer_SetNotificationPositions, 4627), // XREF Uncommenting these fixes dashboard 4920
