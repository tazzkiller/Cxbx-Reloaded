...
// *
// *   CxbxKrnl->HLEDataBase->D3D8.1.0.3925.inl
// *
...
// ******************************************************************
OOVPA_XREF(D3DDevice_SetViewport, 3911, 1 + 28,
...
OOVPA_NO_XREF(CMiniport_InitDMAChannel, 3911, 30) // Also for 4361, 4627, 5558, 5659, 5788, 5849, 5933 (NOT 5344!)
		{ 0x00, 0xBF },
		{ 0x01, 0x15 },
		{ 0x02, 0x7F },
		{ 0x03, 0xF7 },
...
OOVPATable D3D8_3925[] = {
	...
	REGISTER_OOVPA(D3DDevice_CreateVolumeTexture, 3925, DISABLED),
	REGISTER_OOVPA(D3DDevice_CreateCubeTexture, 3925, DISABLED),
	...
	REGISTER_OOVPA(D3DDevice_CreateImageSurface, 3925, DISABLED),
