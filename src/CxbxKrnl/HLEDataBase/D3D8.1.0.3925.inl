...
// ******************************************************************
OOVPA_XREF(D3DDevice_LightEnable, 3911, 1 + 24,
...
OOVPATable D3D8_3925[] = {
	...
	REGISTER_OOVPAS(CMiniport_InitHardware, 3911), // PATCH 
	REGISTER_OOVPAS(CMiniport_CreateCtxDmaObject, 3911), // PATCH 
	REGISTER_OOVPAS(D3D_CMiniport_GetDisplayCapabilities, 3911), // DISABLED
	REGISTER_OOVPAS(Direct3D_CreateDevice, 3911), // PATCH Was 3925
	REGISTER_OOVPAS(D3DDevice_IsBusy, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetDeviceCaps, 3925), // DISABLED
	REGISTER_OOVPAS(D3DDevice_BeginVisibilityTest, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_EndVisibilityTest, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetVisibilityTestResult, 3925), // PATCH 
	REGISTER_OOVPAS(D3D_KickOffAndWaitForIdle, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetMaterial, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetBackMaterial, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_LoadVertexShader, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SelectVertexShader, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Release, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BlockUntilVerticalBlank, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVerticalBlankCallback, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderTarget, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetTransform, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetStreamSource, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexShader, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreatePixelShader, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPixelShader, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetIndices, 3925), // DISABLED
	REGISTER_OOVPAS(D3DDevice_SetViewport, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetTexture2, 3911), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTexture, 3911), // PATCH Was 3925
	REGISTER_OOVPAS(D3DDevice_Begin, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexData2f, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexData2s, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexData4f, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexDataColor, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_End, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Clear, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreatePalette, 3925), // DISABLED
	REGISTER_OOVPAS(D3DDevice_SetPalette, 3925), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_SetVertexShaderConstant, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetFlickerFilter, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetSoftDisplayFilter, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTextureState_TexCoordIndex, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTextureState_BorderColor, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_PSTextureModes, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_StencilFail, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_CullMode, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_Simple, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTransform, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_FogColor, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_FillMode, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_StencilEnable, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_Dxt1NoiseEnable, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_ZBias, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_ZEnable, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Present, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetShaderConstantMode, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetBackBuffer, 3925), // PATCH 
	...
	REGISTER_OOVPAS(D3DVertexBuffer_Lock, 3925), // PATCH 
	...
	REGISTER_OOVPAS(D3DResource_IsBusy, 3925), // PATCH 
	...
	REGISTER_OOVPAS(Get2DSurfaceDesc, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetVertexShaderSize, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetGammaRamp, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetMaterial, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_AddRef, 3925), // PATCH 
	REGISTER_OOVPAS(D3D_CMiniport_GetDisplayCapabilities, 3925), // DISABLED Was D3DDevice_Unknown1 PATCH
	REGISTER_OOVPAS(D3DDevice_GetViewport, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetGammaRamp, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetDisplayFieldStatus, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleAntiAlias, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_VertexBlend, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_BackFillMode, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_TwoSidedLighting, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_NormalizeNormals, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_FrontFace, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_TextureFactor, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_LogicOp, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_EdgeAntiAlias, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleMask, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleMode, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_PersistDisplay, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_ShadowFunc, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_LineWidth, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_YuvEnable, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_OcclusionCullEnable, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_StencilCullEnable, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DrawVertices, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DrawVerticesUP, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DrawIndexedVertices, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DrawIndexedVerticesUP, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DrawRectPatch, 3911), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DrawTriPatch, 3911), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetDisplayMode, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTextureState_BumpEnv, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTextureState_ColorKeyColor, 3925), // PATCH 
	...
	REGISTER_OOVPAS(D3D_AllocContiguousMemory, 3925), // DISABLED Just calls MmAllocateContiguousMemory. Was PATCH
	REGISTER_OOVPAS(D3DDevice_SetRenderState_Deferred, 3925), // DISABLED
	REGISTER_OOVPAS(D3DDevice_GetLight, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetLight, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_LightEnable, 3911), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetLightEnable, 3911), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreateVertexShader, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderTarget, 3948), // PATCH 
	REGISTER_OOVPAS(D3DSurface_GetDesc, 3925), // DISABLED
	REGISTER_OOVPAS(D3DDevice_GetProjectionViewportMatrix, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetTile, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_ApplyStateBlock, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CaptureStateBlock, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DeleteStateBlock, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreateStateBlock, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DeletePixelShader, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPixelShaderProgram, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_KickOff, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetModelView, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_FlushVertexCache, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetScissors, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexShaderInput, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_PrimeVertexCache, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexData4ub, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPixelShaderConstant, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_InsertCallback, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BeginPushBuffer, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_EndPushBuffer, 3925), // PATCH 
	...
	REGISTER_OOVPAS(D3D_SetFence, 3925), // XREF
	REGISTER_OOVPAS(D3DDevice_InsertFence, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_LoadVertexShaderProgram, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DeleteVertexShader, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_RunPushBuffer, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Reset, 3925), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_CreateImageSurface, 3925), // DISABLED
	REGISTER_OOVPAS(D3D_BlockOnTime, 3925), // PATCH 
	REGISTER_OOVPAS(D3D_BlockOnResource, 3925), // PATCH 
	REGISTER_OOVPAS(D3DResource_BlockUntilNotBusy, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BlockOnFence, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BeginStateBlock, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_EndStateBlock, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTile, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetBackMaterial, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SwitchTexture, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetModelView, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CopyRects, 3925), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_RunVertexStateShader, 3925), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_IsFencePending, 3925), // PATCH 
};
