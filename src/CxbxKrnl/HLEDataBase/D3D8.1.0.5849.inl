...
// *
// *   CxbxKrnl->HLEDataBase->D3D8.1.0.5849.inl
// *
...
OOVPATable D3D8_5849[] = {
	...
	REGISTER_OOVPA(D3DDevice_GetLightEnable, 5849, PATCH),
	...
	REGISTER_OOVPA(D3D_BlockOnTime, 5849, PATCH), // Was XREF
	...
	REGISTER_OOVPA(MakeRequestedSpace, 5788, PATCH), // NOT VERIFIED
