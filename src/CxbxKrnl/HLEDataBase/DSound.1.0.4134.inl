...
OOVPATable DSound_4134[] = {
	...
	REGISTER_OOVPAS(CDirectSound_CreateSoundStream, 4134), // XREF
	REGISTER_OOVPAS(IDirectSound_CreateSoundStream, 3936), // PATCH 
	REGISTER_OOVPAS(DirectSoundCreateStream, 4134), // PATCH 
	...
	REGISTER_OOVPAS(CDirectSoundBuffer_Play, 4134), // XREF
	...
	REGISTER_OOVPAS(CDirectSoundVoice_SetPosition, 4134), // XREF
