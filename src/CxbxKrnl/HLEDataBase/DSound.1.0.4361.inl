...
OOVPATable DSound_4361[] = {
	...
	REGISTER_OOVPAS(DirectSoundGetSampleTime, 4361), // PATCH 
	...
	REGISTER_OOVPAS(IDirectSound_CreateSoundBuffer, 4361), // PATCH 
	...
	REGISTER_OOVPAS(CDirectSoundBuffer_Stop, 4361), // XREF
	REGISTER_OOVPAS(IDirectSoundBuffer_Stop, 4361), // PATCH 
	REGISTER_OOVPAS(CDirectSoundVoiceSettings_SetMixBinVolumes, 4361), // XREF
	REGISTER_OOVPAS(CDirectSoundVoice_SetMixBinVolumes, 4361), // XREF
	REGISTER_OOVPAS(CDirectSoundBuffer_SetMixBinVolumes, 4361), // XREF
	...
	REGISTER_OOVPAS(CDirectSoundVoice_SetFormat, 4361), // XREF
	REGISTER_OOVPAS(CDirectSoundBuffer_SetFormat, 4361), // XREF
	REGISTER_OOVPAS(IDirectSoundBuffer_SetFormat, 4361), // PATCH 
	REGISTER_OOVPAS(CDirectSoundStream_SetFormat, 4361), // PATCH 
};
