...
OOVPATable D3D8_5558[] = {
	...
	REGISTER_OOVPAS(CMiniport_InitHardware, 5558), // PATCH 
	REGISTER_OOVPAS(CMiniport_CreateCtxDmaObject, 4361), // PATCH 
	REGISTER_OOVPAS(D3D_CMiniport_GetDisplayCapabilities, 5558), // DISABLED
	...
	REGISTER_OOVPAS(D3DDevice_SelectVertexShader, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreateVertexShader, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexShaderConstant1, 5558), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_SetPalette, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Swap, 5233), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BlockUntilVerticalBlank, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DrawIndexedVertices, 5028), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DrawIndexedVerticesUP, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPixelShader, 5233), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreateTexture2, 5558), // DISABLED
	REGISTER_OOVPAS(D3DDevice_GetDisplayMode, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_End, 5558), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_SetLight, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetMaterial, 5558), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_SetVertexShader, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetIndices, 5558), // DISABLED
	REGISTER_OOVPAS(D3DDevice_SetTexture, 5344), // PATCH 5233
	...
	REGISTER_OOVPAS(D3DDevice_SetTransform, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetStreamSource, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetViewport, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetBackBuffer2, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetBackBuffer2, 5455), // PATCH 
	...
	REGISTER_OOVPAS(D3DTexture_LockRect, 5558), // PATCH 
	...
	REGISTER_OOVPAS(Direct3D_CheckDeviceMultiSampleType, 5558), // DISABLED
	...
	REGISTER_OOVPAS(D3D_SetFence, 5558), // XREF
	REGISTER_OOVPAS(D3DDevice_InsertFence, 3925), // PATCH 
	REGISTER_OOVPAS(D3D_BlockOnTime, 5558), // PATCH Was XREF
	REGISTER_OOVPAS(D3DDevice_BlockOnFence, 5233), // PATCH 
	REGISTER_OOVPAS(D3D_BlockOnResource, 5558), // PATCH Was XREF
	REGISTER_OOVPAS(D3DResource_BlockUntilNotBusy, 5558), // PATCH 
	REGISTER_OOVPAS(D3DVertexBuffer_GetDesc, 5233), // DISABLED
	REGISTER_OOVPAS(D3DDevice_CopyRects, 5233), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetScissors, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetScissors, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetDepthStencilSurface2, 5233), // PATCH 
	REGISTER_OOVPAS(D3DDevice_AddRef, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreatePixelShader, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexShaderConstant4, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DrawVerticesUP, 5558), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_CreateIndexBuffer, 5558), // DISABLED
	REGISTER_OOVPAS(D3DDevice_SetVerticalBlankCallback, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVerticalBlankCallback, 5455), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetSwapCallback, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetGammaRamp, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_TextureFactor, 5558), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_GetViewport, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetProjectionViewportMatrix, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetModelView, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetBackMaterial, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_TwoSidedLighting, 5558), // PATCH 
	...
	REGISTER_OOVPAS(Get2DSurfaceDesc, 5558), // PATCH 
	REGISTER_OOVPAS(MakeRequestedSpace, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_MakeSpace, 5558), // DISABLED
	REGISTER_OOVPAS(D3DDevice_SetRenderTarget, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPixelShaderConstant, 5558), // PATCH 
	REGISTER_OOVPAS(Lock2DSurface, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetFlickerFilter, 5455), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BlockUntilVerticalBlank, 5455), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetScreenSpaceOffset, 5455), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetScreenSpaceOffset, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_InsertCallback, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_LineWidth, 5455), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_LineWidth, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_FlushVertexCache, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_EnableOverlay, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_LogicOp, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_LightEnable, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetLightEnable, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetModelView, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetBackBuffer, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_PersistDisplay, 5558), // PATCH 
	REGISTER_OOVPAS(D3DCubeTexture_GetCubeMapSurface, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetCreationParameters, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexDataColor, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexData4f, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexData2f, 5558), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_LoadVertexShaderProgram, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPixelShaderProgram, 5558), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleMode, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleMode, 5455), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleRenderTargetMode, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleRenderTargetMode, 5455), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_Dxt1NoiseEnable, 5558), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_IsFencePending, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderTargetFast, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetSoftDisplayFilter, 5558), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTile, 5558), // PATCH 
