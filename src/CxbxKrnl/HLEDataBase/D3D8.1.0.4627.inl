...
OOVPATable D3D8_4627[] = {
	...
	REGISTER_OOVPAS(CMiniport_InitHardware, 4627), // PATCH 
	REGISTER_OOVPAS(CMiniport_CreateCtxDmaObject, 4361), // PATCH 
	REGISTER_OOVPAS(D3D_CMiniport_GetDisplayCapabilities, 4627), // DISABLED

	REGISTER_OOVPAS(Direct3D_CreateDevice, 3911), // PATCH Was 4627
	REGISTER_OOVPAS(D3D_CreateDeviceX, 4627), // XREF If hitting a Breakpoint, redirect to Direct3D_CreateDevice.
	REGISTER_OOVPAS(D3D_CheckDeviceFormat, 4134), // DISABLED
	REGISTER_OOVPAS(D3DDevice_BeginVisibilityTest, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetCreationParameters, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_EndVisibilityTest, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetVisibilityTestResult, 3925), // PATCH 
	REGISTER_OOVPAS(D3D_KickOffAndWaitForIdle, 4627), // PATCH 
	REGISTER_OOVPAS(D3D_KickOffAndWaitForIdle2, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BeginPush, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_EndPush, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CopyRects, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetGammaRamp, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetBackBuffer2, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetViewport, 4627), // PATCH 
	REGISTER_OOVPAS(D3D_CommonSetRenderTarget, 4627), // XREF
	REGISTER_OOVPAS(D3D_CommonSetRenderTargetB, 4627), // XREF
	REGISTER_OOVPAS(D3DDevice_SetRenderTarget, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_AddRef, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetGammaRamp, 4928), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetShaderConstantMode, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetRenderTarget2, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetDepthStencilSurface2, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetTile, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTile, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreateIndexBuffer2, 4627), // DISABLED
	REGISTER_OOVPAS(D3DDevice_CreateVertexShader, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPixelShaderConstant, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexShaderConstant1, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexShaderConstant4, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexShaderConstantNotInline, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DeletePixelShader, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreatePixelShader, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPixelShader, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreateTexture2, 4627), // DISABLED
	REGISTER_OOVPAS(D3DDevice_CreateTexture2, 4831), // DISABLED
	REGISTER_OOVPAS(D3DDevice_SetIndices, 4134), // DISABLED
	REGISTER_OOVPAS(D3DDevice_SetIndices, 4627), // DISABLED
	REGISTER_OOVPAS(D3DDevice_GetTexture2, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTexture, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetDisplayMode, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_RunPushBuffer, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Begin, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexData2f, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexData4f, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_End, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Clear, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Swap, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_EnableOverlay, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreateVertexBuffer2, 4627), // DISABLED
	REGISTER_OOVPAS(D3DDevice_UpdateOverlay, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetOverlayUpdateStatus, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BlockUntilVerticalBlank, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVerticalBlankCallback, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetViewport, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTextureState_TexCoordIndex, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTextureState_BumpEnv, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTextureState_BorderColor, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTextureState_ColorKeyColor, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_VertexBlend, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_CullMode, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_NormalizeNormals, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_NormalizeNormals, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_TextureFactor, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_ZBias, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_EdgeAntiAlias, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_EdgeAntiAlias, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_FillMode, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_BackFillMode, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_FogColor, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_Dxt1NoiseEnable, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_Simple, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_ZEnable, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_StencilEnable, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_StencilEnable, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_LineWidth, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_OcclusionCullEnable, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleAntiAlias, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_ShadowFunc, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SwitchTexture, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_YuvEnable, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTransform, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetTransform, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetStreamSource, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetStreamSource, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexShader, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexShader, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DrawVertices, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DrawVerticesUP, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DrawIndexedVertices, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DrawIndexedVerticesUP, 4627), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_SetLight, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetMaterial, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_LightEnable, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetLightEnable, 4627), // PATCH 
	REGISTER_OOVPAS(D3DVertexBuffer_Lock2, 4627), // PATCH 
	...
	REGISTER_OOVPAS(D3DResource_Release, 4627), // PATCH 
	REGISTER_OOVPAS(D3DResource_IsBusy, 4361), // PATCH 
	REGISTER_OOVPAS(D3DResource_GetType, 4627), // DISABLED
	REGISTER_OOVPAS(Get2DSurfaceDesc, 4627), // PATCH 
	REGISTER_OOVPAS(D3DSurface_GetDesc, 3925), // DISABLED
	REGISTER_OOVPAS(D3DSurface_LockRect, 3925), // PATCH 
	REGISTER_OOVPAS(D3DSurface_LockRect, 4627), // PATCH 
	REGISTER_OOVPAS(D3DBaseTexture_GetLevelCount, 4361), // PATCH 
	REGISTER_OOVPAS(D3DTexture_GetSurfaceLevel2, 4627), // PATCH 
	REGISTER_OOVPAS(D3DTexture_LockRect, 3925), // PATCH 
	REGISTER_OOVPAS(D3DVolumeTexture_LockBox, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetViewportOffsetAndScale, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DeleteVertexShader, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SelectVertexShaderDirect, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetShaderConstantMode, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetVertexShader, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetVertexShaderConstant, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexShaderInputDirect, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetVertexShaderInput, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_RunVertexStateShader, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_LoadVertexShader, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_LoadVertexShaderProgram, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SelectVertexShader, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetVertexShaderSize, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BeginStateBlock, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_EndStateBlock, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetVertexShaderType, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetVertexShaderDeclaration, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetVertexShaderFunction, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexShaderInput, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Release, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_StencilFail, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPixelShader, 4721), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Reset, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetScissors, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPalette, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetBackBufferScale, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Reset, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPixelShaderProgram, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetDisplayFieldStatus, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetScreenSpaceOffset, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreateStateBlock, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_InsertCallback, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetProjectionViewportMatrix, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_BackFillMode, 4531), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetDeviceCaps, 3925), // DISABLED
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleMask, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_LogicOp, 4627), // PATCH 
	REGISTER_OOVPAS(D3D_SetFence, 4134), // XREF
	REGISTER_OOVPAS(D3DDevice_InsertFence, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_KickOff, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPixelShaderConstant, 4928), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_TwoSidedLighting, 4134), // PATCH Beware of the typo...
	REGISTER_OOVPAS(D3DDevice_GetTexture2, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetStateVB, 4627), // DISABLED
	REGISTER_OOVPAS(D3DDevice_SetStateUP, 4627), // DISABLED
	REGISTER_OOVPAS(D3DDevice_SetStipple, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_RopZCmpAlwaysRead, 3925), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_PersistDisplay, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_PersistDisplay, 4928), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetSwapCallback, 4928), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_FrontFace, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleMode, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleRenderTargetMode, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_StencilCullEnable, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BeginStateBlock, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_EndStateBlock, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_ApplyStateBlock, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CaptureStateBlock, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DeleteStateBlock, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexData4ub, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexData4f, 4134), // PATCH 
	REGISTER_OOVPAS(D3D_BlockOnTime, 4627), // PATCH Was XREF
	REGISTER_OOVPAS(MakeRequestedSpace, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BlockOnFence, 4627), // PATCH 
	REGISTER_OOVPAS(Lock3DSurface, 4627), // PATCH 
	REGISTER_OOVPAS(Lock2DSurface, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreateImageSurface, 4627), // DISABLED
	REGISTER_OOVPAS(D3DCubeTexture_GetCubeMapSurface2, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetSoftDisplayFilter, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetFlickerFilter, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetPixelShader, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreatePalette2, 4627), // DISABLED
	REGISTER_OOVPAS(D3DPalette_Lock2, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BeginPushBuffer, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_EndPushBuffer, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetPersistedSurface2, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetModelView, 4627), // PATCH 
	REGISTER_OOVPAS(D3D_LazySetPointParams, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetDepthClipPlanes, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetMaterial, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_KickPushBuffer, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetBackMaterial, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetBackMaterial, 4627), // PATCH 
	REGISTER_OOVPAS(D3DCubeTexture_LockRect, 3925), // PATCH TODO: This needs to be verified on 4361, not just 4242!
	REGISTER_OOVPAS(D3D_SetPushBufferSize, 3925), // DISABLED
	REGISTER_OOVPAS(D3DDevice_PrimeVertexCache, 4627), // PATCH 
	REGISTER_OOVPAS(D3D_BlockOnResource, 4627), // PATCH 
