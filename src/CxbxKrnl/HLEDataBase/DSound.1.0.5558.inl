...
OOVPATable DSound_5558[] = {
	...
	REGISTER_OOVPAS(CDirectSound_CommitDeferredSettings, 5558), // PATCH 
	REGISTER_OOVPAS(CDirectSound_SetDistanceFactorA, 5558), // XREF
	REGISTER_OOVPAS(IDirectSound_SetDistanceFactor, 4134), // PATCH 
	REGISTER_OOVPAS(CDirectSound_SetRolloffFactor, 5558), // XREF
	REGISTER_OOVPAS(IDirectSound_SetRolloffFactor, 4134), // PATCH TODO : Use 5344?
	REGISTER_OOVPAS(CDirectSound_SetDopplerFactor, 5558), // XREF
	REGISTER_OOVPAS(CDirectSoundStream_FlushEx, 5233), // XREF
	REGISTER_OOVPAS(IDirectSoundBuffer_StopEx, 5233), // PATCH 
	...
	REGISTER_OOVPAS(CDirectSoundStream_SetFrequency, 5558), // PATCH 
	...
	REGISTER_OOVPAS(CDirectSoundBuffer_SetMaxDistance, 5344), // XREF
	REGISTER_OOVPAS(IDirectSoundBuffer_SetMaxDistance, 5344), // PATCH 
	REGISTER_OOVPAS(CDirectSoundVoice_SetMinDistance, 5344), // XREF
	REGISTER_OOVPAS(CDirectSoundBuffer_SetMinDistance, 5344), // XREF
	REGISTER_OOVPAS(IDirectSoundBuffer_SetMinDistance, 5558), // PATCH 
	REGISTER_OOVPAS(CDirectSoundVoice_SetRolloffFactor, 5344), // XREF
	...
	REGISTER_OOVPAS(CFullHRTFSource_GetCenterVolume, 5558), // XREF
	REGISTER_OOVPAS(CHRTFSource_SetFullHRTF5Channel, 5558), // XREF
	REGISTER_OOVPAS(DirectSoundUseFullHRTF, 5558), // PATCH 
	REGISTER_OOVPAS(DirectSoundDoWork, 5558), // PATCH 
	REGISTER_OOVPAS(CDirectSoundBuffer_SetBufferData, 5558), // XREF
	REGISTER_OOVPAS(IDirectSoundBuffer_SetBufferData, 5558), // PATCH 
	REGISTER_OOVPAS(CMcpxBuffer_SetCurrentPosition, 5558), // XREF
	REGISTER_OOVPAS(CDirectSoundBuffer_SetCurrentPosition, 5558), // XREF
	REGISTER_OOVPAS(IDirectSoundBuffer_SetCurrentPosition, 5558), // PATCH 
	...
	REGISTER_OOVPAS(CDirectSoundVoice_SetVolume, 5233), // XREF
	REGISTER_OOVPAS(CDirectSoundBuffer_SetVolume, 5233), // XREF
	...
	REGISTER_OOVPAS(CMcpxBuffer_Play2, 5558), // XREF
	REGISTER_OOVPAS(CDirectSoundBuffer_Play, 5558), // XREF
	...
	REGISTER_OOVPAS(WaveFormat_CreateXboxAdpcmFormat, 5558), // XREF
	REGISTER_OOVPAS(XAudioCreateAdpcmFormat, 5558), // PATCH 
	...
	REGISTER_OOVPAS(CDirectSoundVoice_SetConeAngles, 5558), // XREF
	REGISTER_OOVPAS(CDirectSoundBuffer_SetConeAngles, 5558), // XREF
	REGISTER_OOVPAS(IDirectSoundBuffer_SetConeAngles, 5558), // PATCH 
	REGISTER_OOVPAS(CDirectSoundVoice_SetRolloffCurve, 5233), // XREF
	REGISTER_OOVPAS(CDirectSoundBuffer_SetRolloffCurve, 4627), // XREF
	REGISTER_OOVPAS(CDirectSoundStream_SetRolloffCurve, 5558), // PATCH 
	REGISTER_OOVPAS(IDirectSoundBuffer_SetRolloffCurve, 4627), // PATCH 
	REGISTER_OOVPAS(CDirectSoundVoice_CommitDeferredSettings, 5558), // XREF
	...
	REGISTER_OOVPAS(CDirectSoundVoice_SetDistanceFactor, 5558), // XREF
	REGISTER_OOVPAS(CDirectSoundBuffer_SetDistanceFactor, 5558), // XREF
	REGISTER_OOVPAS(IDirectSoundBuffer_SetDistanceFactor, 5558), // PATCH 
	REGISTER_OOVPAS(CDirectSoundStream_SetVolume, 4134), // PATCH (This is actually the XREF we are using)
	REGISTER_OOVPAS(DirectSoundCreateBuffer, 4627), // PATCH 
	REGISTER_OOVPAS(IDirectSoundBuffer_Lock, 5558), // PATCH 
	REGISTER_OOVPAS(CDirectSoundVoice_SetI3DL2Source, 5558), // XREF
	REGISTER_OOVPAS(CDirectSoundBuffer_SetI3DL2Source, 5558), // XREF
	REGISTER_OOVPAS(IDirectSoundBuffer_SetI3DL2Source, 5558), // PATCH 
	REGISTER_OOVPAS(CDirectSoundVoice_SetAllParameters, 5558), // XREF
	...
	REGISTER_OOVPAS(CDirectSound_EnableHeadphones, 5558), // XREF
	REGISTER_OOVPAS(IDirectSound8_EnableHeadphones, 5558), // PATCH 
	REGISTER_OOVPAS(CDirectSound_GetOutputLevels, 5558), // XREF
	REGISTER_OOVPAS(IDirectSound_GetOutputLevels, 5558), // PATCH 
	REGISTER_OOVPAS(XAudioDownloadEffectsImage, 5558), // PATCH 
	...
	REGISTER_OOVPAS(CMcpxVoiceClient_SetEG, 5558), // XREF
	REGISTER_OOVPAS(CDirectSoundVoice_SetEG, 5558), // XREF
	REGISTER_OOVPAS(CDirectSoundStream_SetEG, 5558), // PATCH 
	REGISTER_OOVPAS(CDirectSoundBuffer_SetEG, 5558), // XREF
	REGISTER_OOVPAS(IDirectSoundBuffer_SetEG, 5558), // PATCH 
	REGISTER_OOVPAS(IDirectSound_AddRef, 3936), // PATCH 
	REGISTER_OOVPAS(CDirectSound_SetAllParameters, 5558), // XREF
	REGISTER_OOVPAS(IDirectSound_SetAllParameters, 3936), // PATCH 
	REGISTER_OOVPAS(CMcpxVoiceClient_SetFilter, 5558), // XREF
