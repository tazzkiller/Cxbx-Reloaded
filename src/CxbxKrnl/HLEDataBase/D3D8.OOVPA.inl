...
OOVPATable D3D8_OOVPA[] = {
	...
	REGISTER_OOVPAS(D3D_CMiniport_GetDisplayCapabilities, 3911, 3925, 4361, 4627, 5849), // Was D3DDevice_Unknown1
	...
	REGISTER_OOVPAS(D3DDevice_GetMaterial, 3925, 4627),
	REGISTER_OOVPAS(D3DDevice_GetBackMaterial, 3925, 4627, 5788),
	REGISTER_OOVPAS(D3DDevice_SetBackMaterial, 3925, 4627, 5788),
	REGISTER_OOVPAS(D3DDevice_LoadVertexShader, 3925, 4034, 4627, 5028),
	REGISTER_OOVPAS(D3DDevice_SelectVertexShader, 3925, 4039, 4134, 4627, 5558),
	REGISTER_OOVPAS(D3DDevice_Release, 3925, 4134, 4361, 4432, 4627, 5788),
	REGISTER_OOVPAS(D3DDevice_BlockUntilVerticalBlank, 3925, 4039, 4134, 4361, 4432, 4627, 5788),
	REGISTER_OOVPAS(D3DDevice_SetVerticalBlankCallback, 3925, 4361, 4432, 4627, 5788),
	REGISTER_OOVPAS(D3DDevice_SetRenderTarget, 3925, 3948, 4039, 4134, 4627, 5558),
	REGISTER_OOVPAS(D3DDevice_GetStreamSource, 4627),
	REGISTER_OOVPAS(D3DDevice_SetStreamSource, 3925, 4034),
	REGISTER_OOVPAS(D3DDevice_SetVertexShader, 3925, 4034, 4134, 4627, 5558),
	...
	REGISTER_OOVPAS(D3DDevice_SetIndices, 3925, 4034, 4134, 4627, 5558),
	REGISTER_OOVPAS(D3DDevice_SetViewport, 3925, 4034, 4627, 5558),
	REGISTER_OOVPAS(D3DDevice_GetTexture2, 3911, 4627),
	REGISTER_OOVPAS(D3DDevice_SetTexture, 3911, 4034, 4361, 4627, 5344), // Was 3925, 5233
	REGISTER_OOVPAS(D3DDevice_Begin, 3925, 4039, 4134, 4361, 4627),
	REGISTER_OOVPAS(D3DDevice_SetVertexData2f, 3925, 4134, 4627, 5788),
	...
	REGISTER_OOVPAS(D3DDevice_End, 3925, 4134, 4627, 5558),
	REGISTER_OOVPAS(D3DDevice_Clear, 3925, 4034, 4134, 4627, 5028),
	REGISTER_OOVPAS(D3DDevice_CreatePalette, 3925),
	REGISTER_OOVPAS(D3DDevice_CreatePalette2, 4627, 5558),
	REGISTER_OOVPAS(D3DDevice_SetPalette, 3925, 4034, 4134, 4361, 4432, 4627, 5788),
	REGISTER_OOVPAS(D3DDevice_CreateTexture, 3925),
	REGISTER_OOVPAS(D3DDevice_CreateTexture2, 4627, 4831, 5788),
	...
	REGISTER_OOVPAS(D3DDevice_SetVertexShaderConstant1, 4627, 5788),
	...
	REGISTER_OOVPAS(D3DDevice_SetRenderState_Dxt1NoiseEnable, 3925, 4134, 4627, 5558),
	REGISTER_OOVPAS(D3DDevice_SetRenderState_ZBias, 3925),
	REGISTER_OOVPAS(D3DDevice_SetRenderState_ZEnable, 3925, 4034, 4134, 4432, 4627, 5233),
	REGISTER_OOVPAS(D3DDevice_Present, 3925),
	REGISTER_OOVPAS(D3DDevice_Swap, 4034, 4134, 4361, 4432, 4531, 4627, 5233),
	...
	REGISTER_OOVPAS(D3DDevice_GetBackBuffer2, 4627, 5788),
	...
	REGISTER_OOVPAS(D3DDevice_GetDepthStencilSurface2, 4627, 5788),
	REGISTER_OOVPAS(D3DDevice_CreateVertexBuffer, 3925),
	REGISTER_OOVPAS(D3DDevice_CreateVertexBuffer2, 4627, 5558),
	...
	REGISTER_OOVPAS(Get2DSurfaceDesc, 3925, 4034, 4134, 4627, 5849),
	REGISTER_OOVPAS(D3DDevice_GetVertexShaderSize, 3925),
	REGISTER_OOVPAS(D3DDevice_SetGammaRamp, 3925, 4928),
	REGISTER_OOVPAS(D3DDevice_SetMaterial, 3925, 4034, 4134,4627, 5788),
	REGISTER_OOVPAS(D3DDevice_AddRef, 3925, 4361, 4627, 5788),
	REGISTER_OOVPAS(D3DDevice_GetViewport, 3925, 4034, 4361, 4627, 5788),
	REGISTER_OOVPAS(D3DDevice_GetGammaRamp, 3925, 4034),
	REGISTER_OOVPAS(D3DDevice_GetDisplayFieldStatus, 3925, 4627, 5788),
	...
	REGISTER_OOVPAS(D3DDevice_SetRenderState_TwoSidedLighting, 3925, 4034, 4134, 5558), // Beware of the typo...
	...
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleMode, 3925, 4134, 4627, 5788),
	REGISTER_OOVPAS(D3DDevice_PersistDisplay, 3925, 4627, 4928),
	REGISTER_OOVPAS(D3DDevice_SetRenderState_ShadowFunc, 3925, 4034, 4134),
	REGISTER_OOVPAS(D3DDevice_SetRenderState_LineWidth, 3925, 4134, 4432, 4627, 5788),
	...
	REGISTER_OOVPAS(D3DDevice_DrawVerticesUP, 3925, 4134, 4627, 5788),
	REGISTER_OOVPAS(D3DDevice_DrawIndexedVertices, 3925, 4034, 4627, 5028),
	REGISTER_OOVPAS(D3DDevice_DrawIndexedVerticesUP, 3925, 4134, 4627, 5788),
	...
	REGISTER_OOVPAS(D3DDevice_LightEnable, 3911, 4034, 4134, 4361, 4627, 5849),
	REGISTER_OOVPAS(D3DDevice_GetLightEnable, 3911, 4361, 4627, 5849),
	REGISTER_OOVPAS(D3DDevice_CreateVertexShader, 3925),
	REGISTER_OOVPAS(D3DSurface_GetDesc, 3925),
	REGISTER_OOVPAS(D3DDevice_GetProjectionViewportMatrix, 3925, 4432, 4627),
	REGISTER_OOVPAS(D3DDevice_GetTile, 3925, 4134, 4627, 5788),
	...
	REGISTER_OOVPAS(D3DDevice_KickOff, 3925, 4134, 4627, 5788),
	REGISTER_OOVPAS(D3DDevice_SetModelView, 3925, 4432, 4627),
	REGISTER_OOVPAS(D3DDevice_FlushVertexCache, 3925, 4134),
	REGISTER_OOVPAS(D3DDevice_SetScissors, 3925, 4361, 4432, 4627, 5558),
	REGISTER_OOVPAS(D3DDevice_SetVertexShaderInput, 3925, 4361, 4432),
	REGISTER_OOVPAS(D3DDevice_PrimeVertexCache, 3925, 4361, 4627),
	REGISTER_OOVPAS(D3DDevice_SetPixelShaderConstant, 3925, 4134, 4928, 5558),
	REGISTER_OOVPAS(D3DDevice_InsertCallback, 3925, 4627, 5558),
	...
	REGISTER_OOVPAS(D3D_BlockOnTime, 3925, 4627, 5849),
	REGISTER_OOVPAS(D3D_BlockOnResource, 3925, 4627),
	...
	REGISTER_OOVPAS(D3DDevice_SetTile, 3925, 4134, 4627, 5788),
	...
	REGISTER_OOVPAS(D3DDevice_GetVertexShaderConstant, 3925, 4627),
	...
	REGISTER_OOVPAS(D3DDevice_GetPixelShader, 3925, 4627),
	...
	REGISTER_OOVPAS(D3DDevice_BeginPush, 4361,4432, 4627, 5558),
	REGISTER_OOVPAS(D3DDevice_BeginStateBig, 5788),
	REGISTER_OOVPAS(D3DDevice_CreateIndexBuffer2, 4627, 5558),
	REGISTER_OOVPAS(D3DDevice_EnableOverlay, 4134, 4361),
	REGISTER_OOVPAS(D3DDevice_EndPush, 4361, 4627),
	REGISTER_OOVPAS(D3DDevice_GetOverlayUpdateStatus, 4627, 5558),
	...
	REGISTER_OOVPAS(D3DDevice_GetViewportOffsetAndScale, 4627, 5849),
	REGISTER_OOVPAS(D3DDevice_LazySetStateVB, 5558),
	REGISTER_OOVPAS(D3DDevice_SetDepthClipPlanes, 4627, 5849),
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleRenderTargetMode, 4134, 4627, 5788),
	...
	REGISTER_OOVPAS(D3DDevice_SetSwapCallback, 4134, 4928, 5788),
	REGISTER_OOVPAS(D3DDevice_SetVertexShaderConstantNotInline, 4627, 5233),
	REGISTER_OOVPAS(D3DDevice_UpdateOverlay, 4134, 4361, 4432, 4627, 5558),
	...
	REGISTER_OOVPAS(D3D_CommonSetRenderTarget, 4627),
