...
OOVPATable D3D8_5344[] = {
	...
	REGISTER_OOVPAS(Direct3D_CreateDevice, 5344), // PATCH Was 5233
	REGISTER_OOVPAS(MakeRequestedSpace, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetDisplayFieldStatus, 5233), // PATCH 
	REGISTER_OOVPAS(D3D_CheckDeviceFormat, 4134), // DISABLED
	REGISTER_OOVPAS(D3D_KickOffAndWaitForIdle, 5028), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CopyRects, 5233), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetScissors, 5344), // PATCH Was 5233
	...
	REGISTER_OOVPAS(D3DDevice_GetDepthStencilSurface2, 5233), // PATCH 
	REGISTER_OOVPAS(D3D_CommonSetRenderTarget, 5233), // XREF
	REGISTER_OOVPAS(D3DDevice_SetRenderTarget, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_AddRef, 5233), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Reset, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetTile, 5233), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreateIndexBuffer2, 5344), // DISABLED
	...
	REGISTER_OOVPAS(D3DDevice_SetVertexShaderConstantNotInline, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DeletePixelShader, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreatePixelShader, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPixelShader, 5233), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreateTexture2, 5028), // DISABLED Was 4627
	REGISTER_OOVPAS(D3DDevice_SetIndices, 5028), // DISABLED
	REGISTER_OOVPAS(D3DDevice_SetTexture, 5344), // PATCH Was 5233, and 4928 before that
	REGISTER_OOVPAS(D3DDevice_GetDisplayMode, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexData2f, 5028), // PATCH Was 4627
	REGISTER_OOVPAS(D3DDevice_Begin, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_End, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Clear, 5028), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Swap, 5233), // PATCH 
	REGISTER_OOVPAS(D3DDevice_EnableOverlay, 4361), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreateVertexBuffer2, 5344), // DISABLED
	...
	REGISTER_OOVPAS(D3DDevice_SetRenderState_CullMode, 5233), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_NormalizeNormals, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_TextureFactor, 5233), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_SetRenderState_Dxt1NoiseEnable, 5344), // PATCH Was 5233
	REGISTER_OOVPAS(D3DDevice_SetRenderState_Simple, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_ZEnable, 5233), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleMode, 5233), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_MultiSampleRenderTargetMode, 5344), // PATCH Was 5233
	...
	REGISTER_OOVPAS(D3DDevice_SetTransform, 5344), // PATCH Was 4134
	...
	REGISTER_OOVPAS(D3DDevice_SetLight, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_LightEnable, 5344), // PATCH Was 5233
	REGISTER_OOVPAS(D3DDevice_GetLightEnable, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DrawIndexedVertices, 5028), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetMaterial, 5344), // PATCH Was 4627
	REGISTER_OOVPAS(D3DVertexBuffer_GetDesc, 5233), // DISABLED
	REGISTER_OOVPAS(D3DVertexBuffer_Lock2, 4627), // PATCH 
	REGISTER_OOVPAS(D3DResource_Register, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetBackBuffer2, 5344), // PATCH 5233
	REGISTER_OOVPAS(D3DDevice_UpdateOverlay, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetOverlayUpdateStatus, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BlockUntilVerticalBlank, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetViewport, 5344), // PATCH Was 4627
	REGISTER_OOVPAS(D3DDevice_SetViewport, 5344), // PATCH Was 5233
	...
	REGISTER_OOVPAS(D3DTexture_LockRect, 5233), // PATCH 
	REGISTER_OOVPAS(Lock2DSurface, 3925), // PATCH 
	REGISTER_OOVPAS(Get2DSurfaceDesc, 5344), // PATCH Was 5233
	...
	REGISTER_OOVPAS(D3DDevice_DeleteVertexShader, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SelectVertexShaderDirect, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_LoadVertexShader, 5028), // PATCH 
	REGISTER_OOVPAS(D3DDevice_Release, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetScreenSpaceOffset, 5344), // PATCH Was 5233
	REGISTER_OOVPAS(D3D_SetFence, 5233), // XREF
	REGISTER_OOVPAS(D3DDevice_InsertFence, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_IsFencePending, 5233), // PATCH 
	REGISTER_OOVPAS(D3D_BlockOnTime, 5028), // PATCH Was XREF
	REGISTER_OOVPAS(D3DDevice_BlockOnFence, 5233), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetTransform, 3925), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPalette, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetCreationParameters, 4034), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetFlickerFilter, 5344), // PATCH Was 5233
	REGISTER_OOVPAS(D3DDevice_SetSoftDisplayFilter, 5344), // PATCH 5233
	REGISTER_OOVPAS(CMiniport_InitHardware, 4627), // PATCH 
	REGISTER_OOVPAS(CMiniport_CreateCtxDmaObject, 4361), // PATCH 
	REGISTER_OOVPAS(D3D_CMiniport_GetDisplayCapabilities, 5344), // DISABLED
	REGISTER_OOVPAS(D3DDevice_SetRenderState_TwoSidedLighting, 5344), // PATCH 4134
	REGISTER_OOVPAS(D3DDevice_SetRenderState_FrontFace, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetRenderState_LogicOp, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BeginPush, 5233), // PATCH 
	REGISTER_OOVPAS(D3DDevice_BeginVisibilityTest, 4627), // PATCH 
	REGISTER_OOVPAS(D3DDevice_EndPush, 4361), // PATCH Was 4627
	REGISTER_OOVPAS(D3DDevice_SetVerticalBlankCallback, 5344), // PATCH Was 5233
	...
	REGISTER_OOVPAS(D3DDevice_SetSwapCallback, 5344), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_SelectVertexShader, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_IsBusy, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_CreatePalette2, 5344), // DISABLED
	REGISTER_OOVPAS(D3DDevice_DrawVerticesUP, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetVertexDataColor, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetPixelShaderConstant, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetVisibilityTestResult, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_PersistDisplay, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_DrawIndexedVerticesUP, 5344), // PATCH 
	...
	REGISTER_OOVPAS(D3DDevice_GetMaterial, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetBackMaterial, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_SetBackMaterial, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetProjectionViewportMatrix, 5344), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetModelView, 4134), // PATCH 
	REGISTER_OOVPAS(D3DDevice_GetTile, 5344), // PATCH 
	REGISTER_OOVPAS(D3DPalette_Lock, 5344), // PATCH 
