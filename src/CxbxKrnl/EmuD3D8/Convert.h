...
#undef NV2A_USE_CONSTEXPR // TODO : Enable after solving "error C3861: 'NV2A_LIGHT_POSITION_Y': identifier not found"
...
#define ENUM_NV2A(METHOD, RANGED, BITFLD, VALUE) \
	...
	RANGED(NV2A_PROJECTION_MATRIX,								0x00000680, 0x04, 16) \
...
#define ENUM_NV2A_METHOD(X) \
	...
	X(NV2A_VIEWPORT_SCALE1_X) \
	X(NV2A_VIEWPORT_SCALE1_Y) \
	X(NV2A_VIEWPORT_SCALE1_Z) \
	X(NV2A_VIEWPORT_SCALE1_W) \
	...
	X(NV2A_VERTEX_POS_3F_X) \
	X(NV2A_VERTEX_POS_3F_Y) \
	X(NV2A_VERTEX_POS_3F_Z) \
	X(NV2A_VERTEX_POS_4F_X) \
	X(NV2A_VERTEX_POS_4F_Y) \
	X(NV2A_VERTEX_POS_4F_Z) \
	X(NV2A_VERTEX_POS_3I_XY) \
	X(NV2A_VERTEX_POS_3I_Z) \
	X(NV2A_VERTEX_NOR_3F_X) \
	X(NV2A_VERTEX_NOR_3F_Y) \
	X(NV2A_VERTEX_NOR_3F_Z) \
	X(NV2A_VERTEX_NOR_3I_XY) \
	X(NV2A_VERTEX_NOR_3I_Z) \
	X(NV2A_VERTEX_COL_4F_X) \
	X(NV2A_VERTEX_COL_4F_Y) \
	X(NV2A_VERTEX_COL_4F_Z) \
	X(NV2A_VERTEX_COL_4F_W) \
	X(NV2A_VERTEX_COL_3F_X) \
	X(NV2A_VERTEX_COL_3F_Y) \
	X(NV2A_VERTEX_COL_3F_Z) \
	X(NV2A_VERTEX_COL_4I) \
	X(NV2A_VERTEX_COL2_3F_X) \
	X(NV2A_VERTEX_COL2_3F_Y) \
	X(NV2A_VERTEX_COL2_3F_Z) \
	X(NV2A_VERTEX_COL2_4I) \
	X(NV2A_VERTEX_TX0_2F_S) \
	X(NV2A_VERTEX_TX0_2F_T) \
	X(NV2A_VERTEX_TX0_2I) \
	X(NV2A_VERTEX_TX0_4F_S) \
	X(NV2A_VERTEX_TX0_4F_T) \
	X(NV2A_VERTEX_TX0_4F_R) \
	X(NV2A_VERTEX_TX0_4F_Q) \
	X(NV2A_VERTEX_TX0_4I_ST) \
	X(NV2A_VERTEX_TX0_4I_RQ) \
	X(NV2A_VERTEX_TX1_2F_S) \
	X(NV2A_VERTEX_TX1_2F_T) \
	X(NV2A_VERTEX_TX1_2I) \
	X(NV2A_VERTEX_TX1_4F_S) \
	X(NV2A_VERTEX_TX1_4F_T) \
	X(NV2A_VERTEX_TX1_4F_R) \
	X(NV2A_VERTEX_TX1_4F_Q) \
	X(NV2A_VERTEX_TX1_4I_ST) \
	X(NV2A_VERTEX_TX1_4I_RQ) \
	X(NV2A_VERTEX_TX2_2F_S) \
	X(NV2A_VERTEX_TX2_2F_T) \
	X(NV2A_VERTEX_TX2_2I) \
	X(NV2A_VERTEX_TX2_4F_S) \
	X(NV2A_VERTEX_TX2_4F_T) \
	X(NV2A_VERTEX_TX2_4F_R) \
	X(NV2A_VERTEX_TX2_4F_Q) \
	X(NV2A_VERTEX_TX2_4I_ST) \
	X(NV2A_VERTEX_TX2_4I_RQ) \
	X(NV2A_VERTEX_TX3_2F_S) \
	X(NV2A_VERTEX_TX3_2F_T) \
	X(NV2A_VERTEX_TX3_2I) \
	X(NV2A_VERTEX_TX3_4F_S) \
	X(NV2A_VERTEX_TX3_4F_T) \
	X(NV2A_VERTEX_TX3_4F_R) \
	X(NV2A_VERTEX_TX3_4F_Q) \
	X(NV2A_VERTEX_TX3_4I_ST) \
	X(NV2A_VERTEX_TX3_4I_RQ) \
	X(NV2A_VERTEX_FOG_1F) \
	X(NV2A_EDGEFLAG_ENABLE) \
	X(NV2A_LIGHT_MODEL_BACK_SIDE_PRODUCT_AMBIENT_PLUS_EMISSION_R) \
	X(NV2A_LIGHT_MODEL_BACK_SIDE_PRODUCT_AMBIENT_PLUS_EMISSION_G) \
	X(NV2A_LIGHT_MODEL_BACK_SIDE_PRODUCT_AMBIENT_PLUS_EMISSION_B) \
	X(NV2A_COLOR_MATERIAL_BACK_A) \
	X(NV2A_COLOR_MATERIAL_BACK_R) \
	X(NV2A_COLOR_MATERIAL_BACK_G) \
	X(NV2A_COLOR_MATERIAL_BACK_B) \
	X(NV2A_COLOR_LOGIC_OP_ENABLE) \
	X(NV2A_COLOR_LOGIC_OP_OP) \
	X(NV2A_LIGHT_MODEL_TWO_SIDE_ENABLE) \
	X(NV2A_TX_SHADER_CULL_MODE) \
	X(NV2A_VERTEX_BEGIN_END) \
	X(NV2A_VB_ELEMENT_U16) \
	X(NV2A_VB_VERTEX_BATCH) \
	X(NV2A_VERTEX_DATA) \
	X(NV2A_TX_SHADER_CONST_EYE_X) \
	X(NV2A_TX_SHADER_CONST_EYE_Y) \
	X(NV2A_TX_SHADER_CONST_EYE_Z) \
