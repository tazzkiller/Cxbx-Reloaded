...
#define  NV2A_SET_WARNING_ENABLE							0x00000108
#define  NV2A_GET_STATE										0x0000010C
#define  NV2A_WAIT_FOR_IDLE									0x00000110
#define  NV2A_FLIP_READ										0x00000120
#define  NV2A_FLIP_WRITE									0x00000124
#define  NV2A_FLIP_MODULO									0x00000128
#define  NV2A_FLIP_INCREMENT_WRITE							0x0000012C
#define  NV2A_FLIP_STALL									0x00000130
#define  NV2A_PM_TRIGGER									0x00000140
#define  NV2A_DMA_NOTIFY									0x00000180
#define  NV2A_DMA_TEXTURE0									0x00000184
#define  NV2A_DMA_TEXTURE1									0x00000188
#define  NV2A_DMA_STATE										0x00000190
...
#define  NV2A_EYE_POSITION(x)								(0x00000a50+((x)*4))
...
#define   NV2A_RC_OUT_ALPHA_SCALE_MASK								0x000C0000 // Was 0x00000000
...
#define  NV2A_SET_SEMAPHORE_OFFSET							0x00001d6c // New
#define  NV2A_BACK_END_WRITE_SEMAPHORE_RELEASE				0x00001d70 // New
...
#define   NV2A_RC_OUT_RGB_SCALE_MASK								0x000C0000 // Was 0x00000000
...
#if 0 // TODO : Get this compiling, as a replacement for the above :
...
#define ENUM_NV2A(METHOD, RANGED, BITFLD, VALUE) \
	...
	RANGED(NV2A_RC_IN_ALPHA,								0x00000260, 4, 0x00000008) \
	...
	RANGED(NV2A_VIEWPORT_CLIP_HORIZ,						0x000002c0, 4, 0x00000008) \
	RANGED(NV2A_VIEWPORT_CLIP_VERT,							0x000002e0, 4, 0x00000008) \
	...
	RANGED(NV2A_TX_GEN_S,									0x000003c0, 16, 0x00000004) \
	...
	RANGED(NV2A_TX_GEN_T,									0x000003c4, 16, 0x00000004) \
	...
	RANGED(NV2A_TX_GEN_R,									0x000003c8, 16, 0x00000004) \
	...
	RANGED(NV2A_TX_GEN_Q,									0x000003cc, 16, 0x00000004) \
	...
	RANGED(NV2A_TX_MATRIX_ENABLE,							0x00000420, 4, 0x00000004) \
	METHOD(NV2A_POINT_SIZE,									0x0000043c) \
	RANGED(NV2A_MODELVIEW0_MATRIX,							0x00000480, 4, 0x00000010) \
	RANGED(NV2A_MODELVIEW1_MATRIX,							0x000004c0, 4, 0x00000010) \
	RANGED(NV2A_MODELVIEW2_MATRIX,							0x00000500, 4, 0x00000010) \
	RANGED(NV2A_MODELVIEW3_MATRIX,							0x00000540, 4, 0x00000010) \
	RANGED(NV2A_INVERSE_MODELVIEW0_MATRIX,					0x00000580, 4, 0x00000010) \
	RANGED(NV2A_INVERSE_MODELVIEW1_MATRIX,					0x000005c0, 4, 0x00000010) \
	RANGED(NV2A_INVERSE_MODELVIEW2_MATRIX,					0x00000600, 4, 0x00000010) \
	RANGED(NV2A_INVERSE_MODELVIEW3_MATRIX,					0x00000640, 4, 0x00000010) \
	RANGED(NV2A_PROJECTION_MATRIX,							0x00000680, 4, 0x00000010) \
	RANGED(NV2A_TX0_MATRIX,									0x000006c0, 4, 0x00000010) \
	RANGED(NV2A_TX1_MATRIX,									0x00000700, 4, 0x00000010) \
	RANGED(NV2A_TX2_MATRIX,									0x00000740, 4, 0x00000010) \
	RANGED(NV2A_TX3_MATRIX,									0x00000780, 4, 0x00000010) \
	RANGED(NV2A_TX0_CLIP_PLANE_A,							0x00000840,16, 0x00000004) \
	RANGED(NV2A_TX0_CLIP_PLANE_B,							0x00000844,16, 0x00000004) \
	RANGED(NV2A_TX0_CLIP_PLANE_C,							0x00000848,16, 0x00000004) \
	RANGED(NV2A_TX0_CLIP_PLANE_D,							0x0000084c,16, 0x00000004) \
	RANGED(NV2A_TX1_CLIP_PLANE_A,							0x00000880,16, 0x00000004) \
	RANGED(NV2A_TX1_CLIP_PLANE_B,							0x00000884,16, 0x00000004) \
	RANGED(NV2A_TX1_CLIP_PLANE_C,							0x00000888,16, 0x00000004) \
	RANGED(NV2A_TX1_CLIP_PLANE_D,							0x0000088c,16, 0x00000004) \
	RANGED(NV2A_TX2_CLIP_PLANE_A,							0x000008c0,16, 0x00000004) \
	RANGED(NV2A_TX2_CLIP_PLANE_B,							0x000008c4,16, 0x00000004) \
	RANGED(NV2A_TX2_CLIP_PLANE_C,							0x000008c8,16, 0x00000004) \
	RANGED(NV2A_TX2_CLIP_PLANE_D,							0x000008cc,16, 0x00000004) \
	RANGED(NV2A_TX3_CLIP_PLANE_A,							0x00000900,16, 0x00000004) \
	RANGED(NV2A_TX3_CLIP_PLANE_B,							0x00000904,16, 0x00000004) \
	RANGED(NV2A_TX3_CLIP_PLANE_C,							0x00000908,16, 0x00000004) \
	RANGED(NV2A_TX3_CLIP_PLANE_D,							0x0000090c,16, 0x00000004) \
	...
	RANGED(NV2A_FRONT_MATERIAL_SHININESS,					0x000009e0, 4, 0x00000006) \
	...
	RANGED(NV2A_POINT_PARAMETER,							0x00000a30, 4, 0x00000008) \
	RANGED(NV2A_EYE_POSITION,								0x00000a50, 4 \
	RANGED(NV2A_RC_CONSTANT_COLOR0,							0x00000a60, 4, 0x00000008) \
	...
	RANGED(NV2A_RC_CONSTANT_COLOR1,							0x00000a80, 4, 0x00000008) \
	...
	RANGED(NV2A_RC_OUT_ALPHA,								0x00000aa0, 4, 0x00000008) \
	...
	RANGED(NV2A_RC_IN_RGB,									0x00000ac0, 4, 0x00000008) \
	...
	RANGED(NV2A_VP_UPLOAD_INST,								0x00000b00, 4, 0x00000004) \
	RANGED(NV2A_VP_UPLOAD_CONST,							0x00000b80, 4, 0x00000004) \
	RANGED(NV2A_LIGHT_BACK_SIDE_PRODUCT_AMBIENT_R,			0x00000c00, 64, 0x00000008) \
	RANGED(NV2A_LIGHT_BACK_SIDE_PRODUCT_AMBIENT_G,			0x00000c04, 64, 0x00000008) \
	RANGED(NV2A_LIGHT_BACK_SIDE_PRODUCT_AMBIENT_B,			0x00000c08, 64, 0x00000008) \
	RANGED(NV2A_LIGHT_FRONT_SIDE_PRODUCT_AMBIENT_R,			0x00001000, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_FRONT_SIDE_PRODUCT_AMBIENT_G,			0x00001004, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_FRONT_SIDE_PRODUCT_AMBIENT_B,			0x00001008, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_FRONT_SIDE_PRODUCT_DIFFUSE_R,			0x0000100c, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_FRONT_SIDE_PRODUCT_DIFFUSE_G,			0x00001010, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_FRONT_SIDE_PRODUCT_DIFFUSE_B,			0x00001014, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_FRONT_SIDE_PRODUCT_SPECULAR_R,		0x00001018, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_FRONT_SIDE_PRODUCT_SPECULAR_G,		0x0000101c, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_FRONT_SIDE_PRODUCT_SPECULAR_B,		0x00001020, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_HALF_VECTOR_X,						0x00001028, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_HALF_VECTOR_Y,						0x0000102c, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_HALF_VECTOR_Z,						0x00001030, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_DIRECTION_X,							0x00001034, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_DIRECTION_Y,							0x00001038, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_DIRECTION_Z,							0x0000103c, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_POSITION_X,							0x0000105c, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_POSITION_Y,							0x00001060, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_POSITION_Z,							0x00001064, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_CONSTANT_ATTENUATION,					0x00001068, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_LINEAR_ATTENUATION,					0x0000106c, 128, 0x00000008) \
	RANGED(NV2A_LIGHT_QUADRATIC_ATTENUATION,				0x00001070, 128, 0x00000008) \
	METHOD(NV2A_POLYGON_STIPPLE_ENABLE,						0x0000147c) \
	RANGED(NV2A_POLYGON_STIPPLE_PATTERN,					0x00001480, 4, 0x00000020) \
	...
	RANGED(NV2A_VTXBUF_ADDRESS,								0x00001720, 4, 0x00000010) \
	...
	RANGED(NV2A_VTXFMT,										0x00001760, 4, 0x00000010) \
	...
	RANGED(NV2A_VTX_ATTR_4F_X,								0x00001a00, 16, 0x00000010) \
	RANGED(NV2A_VTX_ATTR_4F_Y,								0x00001a04, 16, 0x00000010) \
	RANGED(NV2A_VTX_ATTR_4F_Z,								0x00001a08, 16, 0x00000010) \
	RANGED(NV2A_VTX_ATTR_4F_W,								0x00001a0c, 16, 0x00000010) \
	RANGED(NV2A_TX_OFFSET,									0x00001b00, 64, 0x00000004) \
	RANGED(NV2A_TX_FORMAT,									0x00001b04, 64, 0x00000004) \
	...
	RANGED(NV2A_TX_WRAP,									0x00001b08, 64, 0x00000004) \
	...
	RANGED(NV2A_TX_ENABLE,									0x00001b0c, 64, 0x00000004) \
	...
	RANGED(NV2A_TX_SWIZZLE,									0x00001b10, 64, 0x00000004) \
	BITFLD(NV2A_TX_SWIZZLE_RECT_PITCH_SHIFT,						16) \
	BITFLD(NV2A_TX_SWIZZLE_RECT_PITCH_MASK,							0xffff0000) \
	RANGED(NV2A_TX_FILTER,									0x00001b14, 64, 0x00000004) \
	...
	RANGED(NV2A_TX_NPOT_SIZE,								0x00001b1c, 64, 0x00000004) \
	...
	RANGED(NV2A_TX_PALETTE_OFFSET,							0x00001b20, 64, 0x00000004) \
	RANGED(NV2A_TX_BORDER_COLOR,							0x00001b24, 64, 0x00000004) \
	...
	RANGED(NV2A_TX_SHADER_OFFSET_MATRIX00,					0x00001b28, 64, 0x00000004) \
	RANGED(NV2A_TX_SHADER_OFFSET_MATRIX01,					0x00001b2c, 64, 0x00000004) \
	RANGED(NV2A_TX_SHADER_OFFSET_MATRIX11,					0x00001b30, 64, 0x00000004) \
	RANGED(NV2A_TX_SHADER_OFFSET_MATRIX10,					0x00001b34, 64, 0x00000004) \
	...
	RANGED(NV2A_BACK_MATERIAL_SHININESS,					0x00001e28, 4, 0x00000006) \
	RANGED(NV2A_RC_OUT_RGB,									0x00001e40, 4, 0x00000008) \
	...
	BITFLD(NV2A_TX_RCOMP_NEVER,										0x00000000) \
	BITFLD(NV2A_TX_RCOMP_GREATER,										0x00000001) \
	BITFLD(NV2A_TX_RCOMP_EQUAL,										0x00000002) \
	BITFLD(NV2A_TX_RCOMP_GEQUAL,										0x00000003) \
	BITFLD(NV2A_TX_RCOMP_LESS,										0x00000004) \
	BITFLD(NV2A_TX_RCOMP_NOTEQUAL,									0x00000005) \
	BITFLD(NV2A_TX_RCOMP_LEQUAL,										0x00000006) \
	BITFLD(NV2A_TX_RCOMP_ALWAYS,										0x00000007) \
...
#define ENUM_METHOD_Define(Name, Method) \
const DWORD Name = Method;

#define ENUM_RANGED_Define(Name, Method, Pitch, Repeat) \
const DWORD Name = Method; \
const DWORD Name ## __SIZE = Repeat; \
constexpr inline DWORD Name(int x) { return (Method+((x)*Pitch)); }

#define ENUM_BITFLD_Define(Name, Value) \
const DWORD Name = Value;

#define ENUM_VALUE_Define(Name, Value) \
const DWORD Name = Value;

ENUM_NV2A(ENUM_METHOD_Define, ENUM_RANGED_Define, ENUM_BITFLD_Define, ENUM_VALUE_Define)
#endif
...
#define ENUM_NV2A_METHOD(X) \
	X(NV2A_NOP) \
	X(NV2A_NOTIFY) \
	X(NV2A_SET_WARNING_ENABLE) \
	X(NV2A_GET_STATE) \
	X(NV2A_WAIT_FOR_IDLE) \
	X(NV2A_FLIP_READ) \
	X(NV2A_FLIP_WRITE) \
	X(NV2A_FLIP_MODULO) \
	X(NV2A_FLIP_INCREMENT_WRITE) \
	X(NV2A_FLIP_STALL) \
	X(NV2A_DMA_NOTIFY) \
	X(NV2A_DMA_TEXTURE0) \
	X(NV2A_DMA_TEXTURE1) \
	...
	X(NV2A_CONTROL0) \
	X(NV2A_LIGHT_MODEL) \
	X(NV2A_COLOR_MATERIAL) \
	X(NV2A_FOG_MODE) \
	X(NV2A_FOG_COORD_DIST) \
	X(NV2A_FOG_ENABLE) \
	X(NV2A_FOG_COLOR) \
	X(NV2A_VIEWPORT_CLIP_MODE) \
	X(NV2A_ALPHA_FUNC_ENABLE) \
	X(NV2A_BLEND_FUNC_ENABLE) \
	X(NV2A_CULL_FACE_ENABLE) \
	X(NV2A_DEPTH_TEST_ENABLE) \
	X(NV2A_DITHER_ENABLE) \
	X(NV2A_LIGHTING_ENABLE) \
	X(NV2A_POINT_PARAMETERS_ENABLE) \
	X(NV2A_POINT_SMOOTH_ENABLE) \
	X(NV2A_LINE_SMOOTH_ENABLE) \
	X(NV2A_POLYGON_SMOOTH_ENABLE) \
	X(NV2A_SKIN_MODE) \
	X(NV2A_STENCIL_ENABLE) \
	X(NV2A_POLYGON_OFFSET_POINT_ENABLE) \
	X(NV2A_POLYGON_OFFSET_LINE_ENABLE) \
	X(NV2A_POLYGON_OFFSET_FILL_ENABLE) \
	X(NV2A_ALPHA_FUNC_FUNC) \
	X(NV2A_ALPHA_FUNC_REF) \
	X(NV2A_BLEND_FUNC_SRC) \
	X(NV2A_BLEND_FUNC_DST) \
	X(NV2A_BLEND_COLOR) \
	X(NV2A_BLEND_EQUATION) \
	X(NV2A_DEPTH_FUNC) \
	X(NV2A_COLOR_MASK) \
	X(NV2A_DEPTH_WRITE_ENABLE) \
	X(NV2A_STENCIL_MASK) \
	X(NV2A_STENCIL_FUNC_FUNC) \
	X(NV2A_STENCIL_FUNC_REF) \
	X(NV2A_STENCIL_FUNC_MASK) \
	X(NV2A_STENCIL_OP_FAIL) \
	X(NV2A_STENCIL_OP_ZFAIL) \
	X(NV2A_STENCIL_OP_ZPASS) \
	X(NV2A_SHADE_MODEL) \
	X(NV2A_LINE_WIDTH) \
	X(NV2A_POLYGON_OFFSET_FACTOR) \
	X(NV2A_POLYGON_OFFSET_UNITS) \
	X(NV2A_POLYGON_MODE_FRONT) \
	X(NV2A_POLYGON_MODE_BACK) \
	X(NV2A_DEPTH_RANGE_NEAR) \
	X(NV2A_DEPTH_RANGE_FAR) \
	X(NV2A_CULL_FACE) \
	X(NV2A_FRONT_FACE) \
	X(NV2A_NORMALIZE_ENABLE) \
	X(NV2A_COLOR_MATERIAL_FRONT_R) \
	X(NV2A_COLOR_MATERIAL_FRONT_G) \
	X(NV2A_COLOR_MATERIAL_FRONT_B) \
	X(NV2A_COLOR_MATERIAL_FRONT_A) \
	X(NV2A_SEPARATE_SPECULAR_ENABLE) \
	X(NV2A_ENABLED_LIGHTS) \
	X(NV2A_POINT_SIZE) \
	X(NV2A_FOG_EQUATION_CONSTANT) \
	X(NV2A_FOG_EQUATION_LINEAR) \
	X(NV2A_FOG_EQUATION_QUADRATIC) \
	X(NV2A_SWATH_WIDTH) \
	X(NV2A_FLAT_SHADE_OP) \
	X(NV2A_LIGHT_MODEL_FRONT_SIDE_PRODUCT_AMBIENT_PLUS_EMISSION_R) \
	X(NV2A_LIGHT_MODEL_FRONT_SIDE_PRODUCT_AMBIENT_PLUS_EMISSION_G) \
	X(NV2A_LIGHT_MODEL_FRONT_SIDE_PRODUCT_AMBIENT_PLUS_EMISSION_B) \
	X(NV2A_VIEWPORT_SCALE0_X) \
	X(NV2A_VIEWPORT_SCALE0_Y) \
	X(NV2A_VIEWPORT_SCALE0_Z) \
	X(NV2A_VIEWPORT_SCALE0_W) \
	X(NV2A_POINT_PARAMETER(0)) \
	X(NV2A_POINT_PARAMETER(1)) \
	X(NV2A_POINT_PARAMETER(2)) \
	X(NV2A_POINT_PARAMETER(3)) \
	X(NV2A_EYE_POSITION(0)) \
	X(NV2A_EYE_POSITION(1)) \
	X(NV2A_EYE_POSITION(2)) \
	X(NV2A_EYE_POSITION(3)) \
...
\
	X(NV2A_POLYGON_STIPPLE_ENABLE) \
\
	X(NV2A_EDGEFLAG_ENABLE) \
	X(NV2A_SET_SEMAPHORE_OFFSET) \
	X(NV2A_BACK_END_WRITE_SEMAPHORE_RELEASE) \
	X(NV2A_DEPTHCLIPCONTROL) \
	X(NV2A_MULTISAMPLE_CONTROL) \
	X(NV2A_OCCLUDE_ZSTENCIL_EN) \
	X(NV2A_CLEAR_DEPTH_VALUE) \
	X(NV2A_CLEAR_VALUE) \
	X(NV2A_CLEAR_BUFFERS) \
\
	X(NV2A_TX_SHADER_DOTMAPPING) \
	X(NV2A_TX_SHADER_PREVIOUS) \
	X(NV2A_ENGINE) \
	X(NV2A_VP_UPLOAD_FROM_ID) \
	X(NV2A_VP_START_FROM_ID) \
	X(NV2A_VP_UPLOAD_CONST_ID) \
	X(NV2A_VIEWPORT_TRANSLATE_X) \
	X(NV2A_VIEWPORT_TRANSLATE_Y) \
	X(NV2A_VIEWPORT_TRANSLATE_Z) \
	X(NV2A_VIEWPORT_TRANSLATE_W)
