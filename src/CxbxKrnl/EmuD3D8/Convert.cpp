...
D3DFORMAT EmuXB2PC_D3DFormat(X_D3DFORMAT Format)
{
	...
	default:
		CxbxKrnlCleanup("Unknown X_D3DFORMAT (0x%.8X)", (DWORD)Format);
...
X_D3DFORMAT EmuPC2XB_D3DFormat(D3DFORMAT Format)
{
	...
	default:
		CxbxKrnlCleanup("Unknown D3DFORMAT (0x%.8X)", (DWORD)Format);
		// Never reached
    }
...
D3DMULTISAMPLE_TYPE EmuXB2PC_D3DMULTISAMPLE_TYPE(X_D3DMULTISAMPLE_TYPE Value)
{
	...
	case X_D3DMULTISAMPLE_9_SAMPLES_SUPERSAMPLE_GAUSSIAN:
		return D3DMULTISAMPLE_9_SAMPLES;
	default:
		EmuWarning("Unknown X_D3DMULTISAMPLE_TYPE (0x%.8X). Using D3DMULTISAMPLE_NONE approximation.", (DWORD)Value);
		return D3DMULTISAMPLE_NONE;
	}
}
...
D3DTRANSFORMSTATETYPE EmuXB2PC_D3DTS(X_D3DTRANSFORMSTATETYPE Value)
{
	...
	default:
		CxbxKrnlCleanup("Unknown X_D3DTRANSFORMSTATETYPE (0x%.8X)", (DWORD)Value);
...
X_D3DTRANSFORMSTATETYPE EmuPC2XB_D3DTSS(D3DTRANSFORMSTATETYPE State)
{
	...
	CxbxKrnlCleanup("Unknown D3DTRANSFORMSTATETYPE (0x%.8X)", (DWORD)State);
...
D3DBLENDOP EmuXB2PC_D3DBLENDOP(X_D3DBLENDOP Value)
{
	...
	case X_D3DBLENDOP_REVSUBTRACTSIGNED:
		...
		return D3DBLENDOP_REVSUBTRACT;
	default:
		CxbxKrnlCleanup("Unknown X_D3DBLENDOP (0x%.8X)", (DWORD)Value);
...
D3DBLEND EmuXB2PC_D3DBLEND(X_D3DBLEND Value)
{
	...
	default:
		...
		default:
			CxbxKrnlCleanup("Unknown X_D3DBLEND (0x%.8X)", (DWORD)Value);
			return (D3DBLEND)Value; // Never reached
		}

		EmuWarning("Unsupported X_D3DBLEND (0x%.8X). Using D3DBLEND_ONE approximation.", (DWORD)Value);
		return D3DBLEND_ONE;
	}
}
...
D3DCMPFUNC EmuXB2PC_D3DCMPFUNC(X_D3DCMPFUNC Value)
{
	...
	default:
		if (Value == 0)
			...
			CxbxKrnlCleanup("Unknown X_D3DCMPFUNC (0x%.8X)", (DWORD)Value);
...
D3DFILLMODE EmuXB2PC_D3DFILLMODE(X_D3DFILLMODE Value)
{
	...
	default:
		if (Value == 0)
			...
			CxbxKrnlCleanup("Unknown X_D3DFILLMODE (0x%.8X)", (DWORD)Value);
...
D3DSHADEMODE EmuXB2PC_D3DSHADEMODE(X_D3DSHADEMODE Value)
{
	...
	default:
		if (Value == 0)
			...
			CxbxKrnlCleanup("Unknown X_D3DSHADEMODE (0x%.8X)", (DWORD)Value);
...
D3DSTENCILOP EmuXB2PC_D3DSTENCILOP(X_D3DSTENCILOP Value)
{
	...
	default:
		CxbxKrnlCleanup("Unknown X_D3DSTENCILOP (0x%.8X)", (DWORD)Value);
...
DWORD EmuXB2PC_D3DTEXTUREADDRESS(DWORD Value)
{
	...
	default:
		if (Value == 0)
			...
			CxbxKrnlCleanup("Unknown X_D3DTEXTUREADDRESS (0x%.8X)", (DWORD)Value);
...
DWORD EmuXB2PC_D3DTEXTUREFILTERTYPE(DWORD Value)
{
	...
	default:
		CxbxKrnlCleanup("Unknown X_D3DTEXTUREFILTERTYPE (0x%.8X)", (DWORD)Value);
		return (DWORD)0; // Never reached
	}
}
...
D3DVERTEXBLENDFLAGS EmuXB2PC_D3DVERTEXBLENDFLAGS(X_D3DVERTEXBLENDFLAGS Value)
{
	...
	case X_D3DVBF_3WEIGHTS: return D3DVBF_3WEIGHTS;
		...
		*/
	default:
		CxbxKrnlCleanup("Unsupported X_D3DVERTEXBLENDFLAGS (0x%.8X)", (DWORD)Value);
...
D3DTEXTUREOP EmuXB2PC_D3DTEXTUREOP(X_D3DTEXTUREOP Value)
{
	...
	default:
		CxbxKrnlCleanup("Unsupported X_D3DTEXTUREOP (0x%.8X)", (DWORD)Value);
...
// TODO: XDK-Specific Tables? So far they are the same
{
	...
	case X_D3DCULL_CCW:
		return D3DCULL_CCW;
	default:
		CxbxKrnlCleanup("Unknown X_D3DCULL (0x%.8X)", (DWORD)Value);
...
D3DPRIMITIVETYPE EmuXB2PC_D3DPrimitiveType(X_D3DPRIMITIVETYPE Value)
{
	...
	default:
		CxbxKrnlCleanup("Unknown X_D3DPRIMITIVETYPE (0x%.8X)", (DWORD)Value);
...
DWORD EmuXB2PC_D3DTSS_TCI(DWORD Value)
{
	...
	if ((Value & 0xFFFF0000) > D3DTSS_TCI_CAMERASPACEREFLECTIONVECTOR) // Dxbx note : Cxbx uses 0x00030000, which is not enough for the Strip XDK sample!
		EmuWarning("EmuD3DDevice_SetTextureState_TexCoordIndex: Unknown TexCoordIndex Value (0x%.8X)", Value);

	// BUG FIX: The lower 16 bits were causing false Unknown TexCoordIndex errors.
	// Check for 0x00040000 instead.

	if (Value >= 0x00040000)
		CxbxKrnlCleanup("EmuD3DDevice_SetTextureState_TexCoordIndex: Unknown TexCoordIndex Value (0x%.8X)", Value);
...
XTL::X_D3DRENDERSTATETYPE XTL::DxbxXboxMethodToRenderState(const NV2AMETHOD aMethod)
{
	...
	case /*0x000002A8*/NV2A_FOG_COLOR: return X_D3DRS_FOGCOLOR;
	...
	case /*0x00000298*/NV2A_COLOR_MATERIAL: return X_D3DRS_SPECULARMATERIALSOURCE;
	case /*0x0000029c*/NV2A_FOG_MODE: return X_D3DRS_FOGTABLEMODE;
	case /*0x000002a0*/NV2A_FOG_COORD_DIST: return X_D3DRS_FOGSTART;
	...
	case /*0x00000320*/NV2A_LINE_SMOOTH_ENABLE: return X_D3DRS_EDGEANTIALIAS; // Dxbx note : No Xbox ext. (according to Direct3D8) !
	...
	case /*0x00000370*/NV2A_STENCIL_OP_FAIL: return X_D3DRS_STENCILFAIL;
	...
	//case /*0x0000039c*/NV2A_CULL_FACE: return X_D3DRS_CULLFACE; // Set by CULLMODE, reads X_D3DRS_FRONTFACE. TODO : How to emulate?
	...
	case /*0x000009c0*/NV2A_FOG_EQUATION_CONSTANT: return X_D3DRS_FOGDENSITY;
	case /*0x000009f8*/NV2A_SWATH_WIDTH: return X_D3DRS_SWATHWIDTH;
	case /*0x00000a30*/NV2A_POINT_PARAMETER(0): return X_D3DRS_POINTSIZE; // TODO : What about the other 7?		
	...
	case /*0x00001b08*/NV2A_TX_WRAP(0): return X_D3DRS_WRAP0;
	case /*0x00001b48*/NV2A_TX_WRAP(1): return X_D3DRS_WRAP1;
	case /*0x00001b88*/NV2A_TX_WRAP(2): return X_D3DRS_WRAP2;
	case /*0x00001bc8*/NV2A_TX_WRAP(3): return X_D3DRS_WRAP3;
