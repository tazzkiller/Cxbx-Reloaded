...
void *CxbxRestoreContiguousMemory(char *szFilePath_memory_bin)
{
	...
	// TODO : Assert PhysicalSize >= CHIHIRO_MEMORY_SIZE ?
	...
	void *tiled_memory = (void *)MapViewOfFileEx(
		...
		/* dwFileOffsetHigh */0,
		/* dwFileOffsetLow */0,
		XboxAddressRanges[MemTiled].Size, // Was TILED_MEMORY_CHIHIRO_SIZE, was CONTIGUOUS_MEMORY_SIZE
		(void *)XboxAddressRanges[MemTiled].Start); // Was TILED_MEMORY_BASE = 0xF0000000
