...
{	
	return os << (DWORD)value << " :"
		...
		//LOGRENDER_MEMBER_NAME_TYPE_VALUE(" ?IsLocked", bool, (value & X_D3DCOMMON_ISLOCKED) > 0)
		//LOGRENDER_MEMBER_NAME_TYPE_VALUE(" ?VideoMemory", bool, (value & X_D3DCOMMON_VIDEOMEMORY) > 0)
		;
}
